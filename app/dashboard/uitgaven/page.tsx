  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await addTransaction({
        userId: user.uid,
        type: "expense",
        amount: -Math.abs(parseFloat(amount)), // Ensure negative amount for expenses
        description,
        category,
        date: new Date(date),
      })
      ...
      setError("Er is een fout opgetreden bij het toevoegen van de uitgave")
    } finally {
    ...
    <div className="container mx-auto py-6">
      <div className="grid gap-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            <CardHeader>
              <CardTitle>Nieuwe uitgave</CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  {isSubmitting ? "Bezig met opslaan..." : "Uitgave toevoegen"}
                </button>
              </form>
            </CardContent>
          </Card>
